...
task_agent.py
-------------
Task Identification Agent powered by Google Gemini.

Responsibilities:
- Receive a raw client meeting transcript as input.
- Use Gemini to analyze the transcript.
- Extract pain points, requirements, constraints, and business goals.
- Return a structured TaskAgentOutput (Pydantic model).
"""
